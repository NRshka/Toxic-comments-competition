...
def get_average_rnn(nb_words, embedding_dim, embedding_matrix, max_sequence_length, out_size):
    recurrent_units = 60
    input_layer = Input(shape=(max_sequence_length,))
    embedding_layer = Embedding(nb_words,
                                embedding_dim,
...
def get_average_pos_rnn(nb_words, embedding_dim, embedding_matrix, max_sequence_length, out_size):
    recurrent_units = 56
